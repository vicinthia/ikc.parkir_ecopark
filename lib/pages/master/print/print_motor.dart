...
// import 'package:e_ticket/pages/maer/kasir_weekdays/input.dart';

//void main() => runApp(PrintMotor());

class PrintMotor extends StatefulWidget {
  final List list;
  final int index;
  ...
  PrintMotor(
      ...
      this.id});
  @override
  State<PrintMotor> createState() => _PrintMotorState();
}

class _PrintMotorState extends State<PrintMotor> {
              ...
              ElevatedButton(
                onPressed: () async {
                  if ((await printer.isConnected)) {
                    ...
                    // printer.printNewLine();
                    printer.printNewLine();
                    printer.printCustom('Parkir Wisata Eco Park', 1, 1);
                    ...
                    // printer.printNewLine();
                    printer.print3Column(
                        '${widget.Jumlah}', 'Motor', 'Rp. ${widget.Harga}', 1,
                        format: "%-3s %-16s %8s %n");
                    printer.printNewLine();
                    // printer.printNewLine();
