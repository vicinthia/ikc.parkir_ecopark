import 'package:eparking_ecop/pages/master/model_kasir/result_motor.dart';
...
import 'package:eparking_ecop/pages/master/model_kasir/result.dart';
import 'package:eparking_ecop/pages/master/model_kasir/round_icon_button.dart';
import 'package:eparking_ecop/pages/master/model_kasir/reusable_card.dart';
...
class _InputPageState extends State<InputPage> {
  ...
  void addPost() {
    var url = http.post(
        Uri.parse("http://192.168.1.172/server_parking/api/eticket"),
        body: {
          "tgl": "$tgl",
