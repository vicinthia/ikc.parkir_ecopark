import 'package:eparking_ecop/pages/master/model_kasir/result2.dart';
import 'package:eparking_ecop/pages/master/print/print_motor.dart';
import 'package:eparking_ecop/pages/master/print/print_test.dart';
import 'package:flutter/material.dart';

import 'package:http/http.dart' as http;

import 'package:eparking_ecop/pages/master/model_kasir/calculate.dart';

// import '../print/bluetooth/print_test.dart';

class ResultMotor extends StatefulWidget {
  final String Jumlah;
  final String Harga;
  ...
  @override
  State<ResultMotor> createState() => _ResultMotorState();
}

class _ResultMotorState extends State<ResultMotor> {
